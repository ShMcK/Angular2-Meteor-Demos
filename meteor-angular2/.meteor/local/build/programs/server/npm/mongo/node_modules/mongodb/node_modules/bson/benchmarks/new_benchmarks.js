var BSONNATIVE = require('../lib/bson/index').BSONNative.BSON,
	Long = require('../lib/bson/index').Long,
	ObjectID = require('../lib/bson/index').ObjectID,
	Binary = require('../lib/bson/index').Binary,
	Code = require('../lib/bson/index').Code,
	DBRef = require('../lib/bson/index').DBRef,
	Symbol = require('../lib/bson/index').Symbol,
	Double = require('../lib/bson/index').Double,
	MaxKey = require('../lib/bson/index').MaxKey,
	MinKey = require('../lib/bson/index').MinKey,
	Timestamp = require('../lib/bson/index').Timestamp;

var BSONJSOLD = require('../lib/bson/index').BSONPure.BSON
