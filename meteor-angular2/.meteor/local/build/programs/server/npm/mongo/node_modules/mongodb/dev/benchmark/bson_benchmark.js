var BSON = require('../../lib/mongodb/index').BSONNative.BSON,
  ...
  Long = require('../../lib/mongodb/index').BSONNative.Long,
  Binary = require('../../lib/mongodb/index').BSONNative.Binary,
  debug = require('util').debug,
  inspect = require('util').inspect,

  Long = require('../../lib/mongodb/index').Long,
  ObjectID = require('../../lib/mongodb/index').ObjectID,
  Binary = require('../../lib/mongodb/index').Binary,
  Code = require('../../lib/mongodb/index').Code,
  DBRef = require('../../lib/mongodb/index').DBRef,
  Symbol = require('../../lib/mongodb/index').Symbol,
  Double = require('../../lib/mongodb/index').Double,
  MaxKey = require('../../lib/mongodb/index').MaxKey,
  MinKey = require('../../lib/mongodb/index').MinKey,
  Timestamp = require('../../lib/mongodb/index').Timestamp;
