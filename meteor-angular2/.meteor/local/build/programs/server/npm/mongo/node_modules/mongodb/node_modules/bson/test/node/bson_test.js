var mongodb = process.env['TEST_NATIVE'] != null ? require('../../lib/bson/index').native() : require('../../lib/bson/index').pure();

var testCase = require('nodeunit').testCase,
  mongoO = require('../../lib/bson/index').pure(),
...
exports['Should Correctly get BSON types from require'] = function(test) {
  var _mongodb = require('../../lib/bson/index');
